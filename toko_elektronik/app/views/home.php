...
<div class="container">
  <h2 class="text-center mb-5 mt-5">DATA PENJUALAN BARANG DI TOKO ELEKTRONIK</h2>
  ...
  <?php foreach( $data['stf'] as $stf ) : ?>
    <tr>
      ...
      <td class="text-center"><?= $stf['kodebarang']; ?></td>
  ...
  <div class="modal fade" id="formModal">
    <div class="modal-dialog">
      ...
      <div class="modal-header">
        <h5 class="modal-title" id="formModalLabel">Tambah Data Toko</h5>
        ...
        <input type="hidden" name="id" id="id">
            ...
            <div class="form-group">
              <label for="nopart">Kode Barang</label>
